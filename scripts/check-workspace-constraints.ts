...
/** Installer-only applications that participate in the workspace without an npm release. */
const privateAppDirectories = new Set(['apps/desktop'])

const localArtifactDirs = new Set(['node_modules'])
const appPackageFiles: Readonly<Record<string, readonly string[]>> = {
  '@deepseek-ai/dsh': ['lib/*.js', 'config'],
  '@deepseek-ai/dsh-desktop': ['lib/**/*', 'assets/**/*', 'package.json'],
...
function expectedDshPackageFiles(manifest: PackageManifest): readonly string[] {
  ...
  return [
    ...
    ...exportDefault(manifest, './desktop-parent-picker') === './lib/desktop-parent-picker.js'
      ? ['lib/desktop-parent-picker.js']
      : [],
